...
export interface CryticERC20ExternalTestBaseInterface extends utils.Interface {
  functions: {};
...
export interface CryticERC20ExternalTestBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CryticERC20ExternalTestBaseInterface;
