...
export interface IJasmineEATInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface IJasmineEAT extends BaseContract {
  connect(runner?: ContractRunner | null): IJasmineEAT;
  waitForDeployment(): Promise<this>;

  interface: IJasmineEATInterface;
