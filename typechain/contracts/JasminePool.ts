...
export interface JasminePoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface JasminePool extends BaseContract {
  connect(runner?: ContractRunner | null): JasminePool;
  waitForDeployment(): Promise<this>;

  interface: JasminePoolInterface;
  ...
  initialize: TypedContractMethod<
    [policy_: BytesLike, name_: string, symbol_: string],
    [void],
    "nonpayable"
  >;
