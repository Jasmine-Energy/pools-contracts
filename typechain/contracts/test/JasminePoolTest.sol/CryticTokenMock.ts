...
export interface CryticTokenMockInterface extends utils.Interface {
  functions: {
...
export interface CryticTokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CryticTokenMockInterface;
  ...
  functions: {
    ...
    initialize(
      policy_: PromiseOrValue<BytesLike>,
  ...
  estimateGas: {
    ...
    isMintableOrBurnable(overrides?: CallOverrides): Promise<BigNumber>;
