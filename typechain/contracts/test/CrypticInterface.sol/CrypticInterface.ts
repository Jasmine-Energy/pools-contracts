...
export interface CrypticInterfaceInterface extends utils.Interface {
  functions: {
...
export interface CrypticInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrypticInterfaceInterface;
