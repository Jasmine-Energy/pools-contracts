...
// File @openzeppelin/contracts-upgradeable/access/Ownable2StepUpgradeableUpgradeable.sol@v4.9.2

// Original license: SPDX_License_Identifier: MIT
// OpenZeppelin Contracts (last updated v4.9.0) (access/Ownable2StepUpgradeable.sol)
...
abstract contract Ownable2StepUpgradeable is Initializable, OwnableUpgradeable {
    function __Ownable2StepUpgradeable_init() internal onlyInitializing {
        __Ownable_init_unchained();
    }

    function __Ownable2StepUpgradeable_init_unchained() internal onlyInitializing {
    }
    ...
    function acceptOwnership() public virtual {
        ...
        require(pendingOwner() == sender, "Ownable2StepUpgradeable: caller is not the new owner");
...
// File @openzeppelin/contracts/interfaces/IERC2612.sol@v4.9.2
...
// File @openzeppelin/contracts/interfaces/draft-IERC2612.sol@v4.9.2
...
// File @openzeppelin/contracts/interfaces/IERC1155Receiver.sol@v4.9.2
...
// File @openzeppelin/contracts/interfaces/IERC1363.sol@v4.9.2
...
// File @openzeppelin/contracts/utils/introspection/IERC1820Registry.sol@v4.9.2
...
// File @openzeppelin/contracts/interfaces/IERC1820Registry.sol@v4.9.2
...
// File @openzeppelin/contracts/interfaces/IERC20Metadata.sol@v4.9.2
...
// File @openzeppelin/contracts/utils/introspection/ERC165Checker.sol@v4.9.2
...
// File contracts/interfaces/core/IJasmineEAT.sol
...
// File contracts/interfaces/ERC/IERC1046.sol
...
// File contracts/interfaces/pool/IJasmineEATBackedPool.sol
...
// File contracts/interfaces/pool/IJasmineQualifiedPool.sol
...
// File contracts/interfaces/pool/IJasmineRetireablePool.sol
 ...
 * @custom:security-contact dev@jasmine.energy
 */
interface IJasmineRetireablePool is IJasmineEATBackedPool {
...
// File contracts/interfaces/IJasminePool.sol
...
// File contracts/interfaces/core/IJasmineOracle.sol
...
// File contracts/libraries/PoolPolicy.sol
...
// File contracts/interfaces/IJasminePoolFactory.sol
...
// File contracts/interfaces/IRetirementService.sol
 ...
 * @custom:security-contact dev@jasmine.energy
 */
interface IRetirementService is IERC1155ReceiverUpgradeable {
...
// File contracts/interfaces/pool/IJasmineFeePool.sol
 ...
 * @custom:security-contact dev@jasmine.energy
 */
interface IJasmineFeePool is IJasmineEATBackedPool, IJasmineRetireablePool {
...
// File contracts/interfaces/errors/JasmineErrors.sol
...
// File contracts/interfaces/IJasmineFeeManager.sol
...
// File contracts/JasminePoolFactory.sol
    ...
    UUPSUpgradeable
{
        ...
        external initializer onlyProxy
    {
        ...
        __Ownable2StepUpgradeable_init();
        ...
        private view 
    {
        ...
        interfaceIds[1] = type(IERC1155ReceiverUpgradeable).interfaceId;
        ...
        if (!interfaceChecks[0]) {
            ...
            revert MustSupportInterface(type(IERC1155ReceiverUpgradeable).interfaceId);
        }
...
// File contracts/interfaces/core/IJasmineMinter.sol
...
// File contracts/interfaces/IRetirementRecipient.sol
...
// File contracts/libraries/Calldata.sol
...
// File contracts/JasmineRetirementService.sol
    ...
    UUPSUpgradeable
{
    ...
    /// @dev inheritdoc ERC1155ReceiverUpgradeable
    function onERC1155Received(
        address,
        address from,
        uint256 tokenId,
...
// File @openzeppelin/contracts/utils/structs/BitMaps.sol@v4.9.2
...
// File contracts/libraries/StructuredLinkedList.sol
...
// File contracts/pools/core/implementations/EATManager.sol
 ...
 * @custom:security-contact dev@jasmine.energy
 */
abstract contract EATManager is IERC1155ReceiverUpgradeable {
...
// File contracts/interfaces/ERC/IERC6093.sol
...
// File contracts/pools/core/implementations/ERC20.sol
...
// File contracts/pools/core/implementations/ERC20Permit.sol
...
// File contracts/pools/core/JasmineBasePool.sol
    ...
    ReentrancyGuard
{
    ...
    /// @inheritdoc IJasmineEATBackedPool
    function deposit(
        uint256 tokenId,
        uint256 amount
    )
    ...
    /// @inheritdoc IJasmineRetireablePool
    function retire(
        address from, 
        address beneficiary,
        uint256 amount, 
    ...
    /// @inheritdoc IJasmineQualifiedPool
...
// File contracts/pools/extensions/JasmineFeePool.sol
 ...
 * @custom:security-contact dev@jasmine.energy
 */
abstract contract JasmineFeePool is JasmineBasePool, IJasmineFeePool {
    ...
    function retire(
        ...
        external virtual 
        override(IJasmineRetireablePool, JasmineBasePool)
    {
    ...
    function withdraw(
        ...
        external virtual
        override(IJasmineEATBackedPool, JasmineBasePool)
        returns (
            uint256[] memory tokenIds,
            uint256[] memory amounts
        )
...
// File contracts/JasminePool.sol
